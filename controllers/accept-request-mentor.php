...
if($status == 1) {
	...
	$emailContent = "<h3>Hello there (:</h3> <p>Welcome! Looks like your account have been aproved by the admin. Excited? Well I hope so, you can enjoy all the mythy powers you have been granted as a mentor. Use them wisely! (:</p> <p>You can access the application now at http://esohintern.bucatzel.ro/login.php.</p> <h4>Enjoy and have a nice day!</h4>";
