...
try {
	...
	echo $template->render(array('last_name' => $user->last_name, 'profile_image' => $user->profile_image, 'errorMessage' => $errorMessage, 'user_role' => $user->user_role, 'path' => $path, 'coursesWithExercises' => $coursesWithExercises));
} catch (Exception $e) {
